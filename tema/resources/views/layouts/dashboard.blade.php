		...
		<nav class="navbar navbar-inverse navbar-fixed-top striped-bg" id="top-navbar">
		  <div class="container-fluid">
		    <div class="navbar-header">	      
		      ...
		      <a class="navbar-brand" href="{{ url ('') }}"><i class="fa fa-paper-plane"></i>&nbsp;Dashy</a> <div class="solution">>&nbsp;</i>By the Developers. For the Developers</div>
		    </div>
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav navbar-right top-nav">
		        ...
		        <li class="dropdown">
		          	<a href="#" class="dropdown-toggle admin-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
		          		<img class="img-circle admin-img" src="{{ url ('img/profile1.jpg') }}" alt="">&nbsp;&nbsp;&nbsp;<span class="add">Admin&nbsp;
						...
						<div class="tab-content-scroller tab-content sidebar-section-wrap">
						    <div role="tabpanel" class="tab-pane active" id="menu">
						    	<div class="photo-container text-center">
									...
									<div class="t-p">
										<a href="{{ url ('profile') }}">Kumar Sanket</a>
									</div>
								</div>
						    	<div class="section-heading">Menus</div>
								<ul class="nav sidebar-nav ">
							        <li {{ (Request::is('/') ? 'class=active' : '') }} ><a href="{{ url ('') }}"><i class="fa fa-home"></i> Home</a>
							        </li>
